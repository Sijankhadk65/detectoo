"""SQLAlchemy model for plant-care to-do items (CareTask).

Named ``care_task`` (not ``task``) to avoid collision with background-job tooling
...
class CareTask(Base):
    """A plant-care to-do item owned by a user."""
