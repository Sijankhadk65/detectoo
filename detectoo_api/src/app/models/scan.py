"""SQLAlchemy model for a recorded plant scan."""
...
class Scan(Base):
    """A scan of a plant that identifies species and any detected issues.

    Detected issues are stored inline as JSONB so they are immutable per scan.
    """
